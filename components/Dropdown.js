...
export default function Dropdown() {
  ...
  return (
    ...
    <div className='w-full absolute lg:right-1 lg:left-1 right-6 left-10 group'>
        ...
        <div className='px-1 py-1'>
          <Menu.Item>
            {({active})=> (
              ...
              group flex rounded-md items-center w-full px-2 py-2 text-sm font-semidbold tracking-wide text-white cursor-default`}
...
{/*<div className=" ml-3 mr-3 p-4"></div>*/}
