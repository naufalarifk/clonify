...
<img src={track.albumUrl} alt='' className="rounded-xl h-12 w-12 object-contain mr-3"/>
<div>
...
<div className="md:ml-auto flex items-center space-x-2.5">
    ...
    <ImHeadphones className='text-lg ml-16'/>
    ...
    {track.uri === playingTrack.uri && play ? (
      <div className='h-10 w-10 rounded-full border border-[#15883e] flex items-center justify-center absolute -right-0.5 bg-[#15833e] icon hover:scale-110'onClick={handlePlay}>
        <BsFillPauseFill className='text-white text-xl'/>
      </div>

    ) : (
      <div className='h-10 w-10 rounded-full border border-[#15883e] flex items-center justify-center absolute -right-0.5 hover:bg-[#15833e] icon hover:scale-110'
      onClick={handlePlay}
      >
